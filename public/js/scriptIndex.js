...
`
        ...
        <button class="btn btn-success btn-sm btn-apply-trigger" data-bs-toggle="modal" data-bs-target="#applyModal" data-job-id="${post.id_post}">Apply</button>
</div>`;
...
// DELETE
    document.addEventListener("click", (e) => {
      const btn = e.target.closest(
        ".btn-view-detail[data-bs-target='#deleteModal']",
      );
      if (!btn) return;
